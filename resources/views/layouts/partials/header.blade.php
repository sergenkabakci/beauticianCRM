            ...
            <div class="header__inner">
                ...
                <div class="header__brand">
                    <div class="brand-wrap">
                        ...
                        <!-- Brand title -->
                        <div class="brand-title"><a href="{{ route('dashboard.index') }}" class="text-decoration-none text-white">Portal</a></div>
                ...
                <div class="header__content">
                    ...
                    <div class="header__content-start">
                        ...
                        <div class="header-searchbox">
                            ...
                            <!-- Searchbox input -->
                            <form class="searchbox searchbox--auto-expand searchbox--hide-btn input-group navbar-search-wrapper search-input-wrapper">
                                <input id="header-search-input" class="search-input searchbox__input form-control bg-transparent" type="search" placeholder="Ara..." aria-label="Search">
                                <div class="searchbox__backdrop">
                                    <button class="search-toggler searchbox__btn header__btn btn btn-icon rounded shadow-none border-0 btn-sm" type="button" id="button-addon2">
                            ...
                            <div class="dropdown-menu dropdown-menu-end w-md-450px">
                                ...
                                <div class="d-flex align-items-center border-bottom px-3 py-2">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="mb-0">{{Auth::user()->ad}} {{Auth::user()->soyad}}</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="list-group list-group-borderless h-100 py-3">
                                            <a href="#" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                                <span><i class="demo-pli-mail fs-5 me-2"></i> {{ __('Messages') }}</span>
                                                <span class="badge bg-danger rounded-pill">14</span>
                                            </a>
                                            <a href="#" class="list-group-item list-group-item-action">
                                                <i class="demo-pli-male fs-5 me-2"></i> {{ __('Profile') }}
                                            </a>
                                            <a href="{{ route('settings.index') }}" class="list-group-item list-group-item-action">
                                                <i class="demo-pli-gear fs-5 me-2"></i> {{ __('Settings') }}
                                            </a>
                                            ...
                                            <a href="{{ route('logout') }}" class="list-group-item list-group-item-action">
                                                <i class="demo-pli-unlock fs-5 me-2"></i> {{ __('Logout') }}
                                            </a>
                                        </div>
